 ...
 */
public class TimeBankDemoState implements SwirldState {
	/**
	...
	public synchronized FastCopyable copy() {
		TimeBankDemoState copy = new TimeBankDemoState();
		copy.copyFrom(this);
		return copy;
	}
	...
	public synchronized void copyFrom(SwirldState old) {
		strings = new ArrayList<String>(((TimeBankDemoState) old).strings);
		services = new HashMap<String, String>(((TimeBankDemoState) old).services);
		balances = new HashMap<String, Integer>(((TimeBankDemoState) old).balances);
		addressBook = ((TimeBankDemoState) old).addressBook.copy();
	}
